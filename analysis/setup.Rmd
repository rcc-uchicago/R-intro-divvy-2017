...
1. You have two options for running R or Rstudio for this workshop:
(a) you can run R/RStudio on your computer, or; (b) if you have an RCC
account, you can run R/RStudio on the RCC compute cluster. If you use
the RCC cluster, I recommend connecting using
[ThinLinc](https://rcc.uchicago.edu/docs/connecting/#connecting-with-thinlinc).

1. Install R from the [CRAN website](http://cran.r-project.org) and,
optionally,
[Rstudio Desktop](https://www.rstudio.com/products/rstudio/download).
*Note:* If you do not use RStudio, you will need to have additional
software installed for X Windows graphics (e.g.,
...
prepare the data files for analysis. **Easiest approach:** t download
...
provided a script `code/retrieve_divvy_data.sh` to do this
...
reproduces how the data were obtained from the
...
"analysis" directory of the local git repository. For example, on my
MacBook Air, the current working directory in R is
