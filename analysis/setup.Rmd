...
workshop: (a) you can run R/RStudio on your computer, or; (b) if you
have an RCC user account, you can run R/RStudio on the RCC compute
cluster. If you use the RCC cluster, I recommend connecting using
...
with a [Yubikey](yubikey.html).

2. Install R from the [CRAN website](http://cran.r-project.org) and,
optionally,
...
reproduces the data preparation steps starting from the 
...
module. For example, to run RStudio Desktop with R 3.3.2, do the
following:
