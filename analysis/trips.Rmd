...
accommodate the format of the date & time data stored in the Divvy
CSV files.
...
packages that can process the data efficiently. But once we take the
effort to process the data carefully, we can quickly get insights into
the data using basic R commands.

In the [next episode](plots.Rmd), we will use the station and trip
