...
The cowplot package also comes with a nice theme, so let's use
it. Also, the "plot_grid" function has a great feature for aligning
plots along the axes for better comparison.
