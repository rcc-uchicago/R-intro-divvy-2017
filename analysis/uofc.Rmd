...
What could explain this pattern? Let's start by visualizing this
pattern. Let's create a variable storing counts of the number of trips
by arrival station.
...
My hypothesis is that geography can explain this trend---the 
