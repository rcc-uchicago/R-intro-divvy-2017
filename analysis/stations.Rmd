...
For example, this is one of the Divvy stations on campus:
...
Now we have an easier way to access the same information:
...
data from a text file into a dta frame, inspecting the data frame, and
making a few simple (but useful!) modifications to the data frame.  In
[the next episode](trips.), we will explore these same tools, but in a
much larger data table---the Divvy trip data.
